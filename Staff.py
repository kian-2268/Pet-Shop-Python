...
attendance_icon = load_icon(r"C:\Users\user\Pictures\project\user-check.png")
...
#user stff_btn
user_btn = tk.Button(sideBar, text="Staff", image=user_icon, compound="left", bg="#F1A842", fg="white",
...
attendance_btn = tk.Button(sideBar, text="Attendance", image=attendance_icon, compound="left", bg="#F9D162", fg="#2D3436",
                      font=("Arial", 12, "bold"), relief="flat", width=180, height=40, padx=10, anchor="w")
attendance_btn.img = attendance_icon
attendance_btn.place(x=40, y=380)
